                    ...
                    <div class="card">
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <form class="form" id="infoAddGallery">
                                    <div class="form-body">
                                    ...
                                    <div class="form-actions right">
                                        <button type="button" class="btn btn-outline-warning mr-1" onclick="window.location.href ='<?php echo site_url('yonetim-paneli/galeri'); ?>'">
                                            <i class="ft-x"></i> Çık
                                        </button>
