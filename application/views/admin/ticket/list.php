                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tr>
                                                ...
                                                <th style="width: 35%;">Etiket Resmi</th>
                                            ...
                                            <?php if(!empty($ticket)) { ?>
                                                <?php foreach ($ticket as $key => $val) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button onclick="window.location.href='<?php echo site_url('yonetim-paneli/etiket-duzenle/'.$val->id); ?>'" class="w-100 btn btn-warning buttonAnimation" data-animation="pulse"><i class="la la-refresh"></i></button>
                                                        </td>
