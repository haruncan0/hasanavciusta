                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Ürünleri Listele</li>
                        </ol>
                    </div>
                </div>
            </div>
                                                ...
                                                <?php if(!empty($product)) { ?>
                                                    <?php foreach ($product as $key => $val) { ?>
                                                        <tr id="delete<?php echo $val->id; ?>">
                                                            ...
                                                            <td>
                                                                <input type="checkbox" class="switch product-list-status"
                                                            ...
                                                            <td>
                                                                <button onclick="window.location.href='<?php echo site_url('yonetim-paneli/urunu-duzenle/'.$val->id); ?>'" class="w-100 btn btn-warning buttonAnimation" data-animation="pulse"><i class="la la-refresh"></i></button>
                                                            </td>

                                                            <td>
                                                                <button class="w-100 btn btn-danger buttonAnimation delete-product-list"
                                                                data-id="<?php echo $val->id; ?>"
